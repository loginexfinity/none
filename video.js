        ...
        init = (el, clicked) => {
            const items = Themify.selectWithParent('module-video', el),
                enter = e => {
                    ...
                    if (!el.tfClass('tb_video_buffer')[0]) {
                        const bar = document.createElement('div'),
                            progress = function(e) {
                                ...
                                if (this.readyState > 2) {
                                    buffered = 100;
                                    el.tfOff('pointerenter', enter, {
                                        passive: true
                                    });
                                    this.tfOff('loadstart waiting progress canplay', progress, {
                                        passive: true
                                    });
                        ...
                        video.tfOn('loadstart waiting progress canplay', progress, {
                            passive: true
                        });
                    }
                    video.load();
            ...
            for (let i = items.length - 1; i > -1; --i) {
                ...
                if (!cl.contains('tb_hover_play')) {
                    ...
                    item.tfTag('img')[0] ? .parentNode.tfOn('pointerenter', enter, {
                        passive: true
                    });
                }
                cl.remove('tf_lazy');
